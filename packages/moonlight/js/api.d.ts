...
export interface EditorHandle {
  ...
  /** Clear all elements */
  clear(): void;
  /** Insert an embedded image and return the created element id */
  insertImage(src: string, width?: number, height?: number): string;
 ...
 * @example
 * ```typescript
 * import { createEditor } from '@f12o/papyr-moonlight';
 *
