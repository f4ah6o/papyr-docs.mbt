...
This is Papyr's vendored copy of `mizchi/moonlight`. Papyr carries local changes here instead of
sending them upstream: embedded image elements, paste-to-data-URL support, and editable Moonlight
SVG export/import.
...
<script>
  const editor = MoonlightEditor.create(document.getElementById('editor-container'), {
    width: 800,
    height: 600,
    theme: 'light', // or 'dark'
    readonly: false,
...
<moonlight-editor width="800" height="600" theme="light"> </moonlight-editor>
